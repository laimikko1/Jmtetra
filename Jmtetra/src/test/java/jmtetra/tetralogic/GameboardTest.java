...
public class GameboardTest {
    ...
    @Test
    public void isGameOverReturnsFalseWhenPieceNotAtTop() {
        ...
        initializeGameBoardsToTest(testBoard1);
        this.g.addTetronome(tetronome);
        this.g.updateBoard(g.getCurTetro().moveDown());
        this.g.updateBoard(g.getCurTetro().moveDown());
        assertFalse(this.g.isGameOver());
    }
